...
$(function(){
	$("#personInfo li:eq(0)").click(function(event) {
		$("#base_right").empty().load("s_tianjia_xuesheng_xinxi.html");
	});
	$("#personInfo li:eq(1)").click(function(event) {
		$("#base_right").empty().load("s_chaxun_xuesheng_xinxi.html");
	});
	$("#personInfo li:eq(2)").click(function(event) {
		$("#base_right").empty().load("s_xiugai_xuesheng_xinxi.html");
	});
	$("#personInfo li:eq(3)").click(function(event) {
		$("#base_right").empty().load("s_chaxun_xinxi.html");
	});
	$("#personInfo li:eq(4)").click(function(event) {
		$("#base_right").empty().load("s_personInfo_modify.html");
	});
	/*$("#personInfo li:eq(5)").click(function(event) {
		$("#base_right").empty().load();
	});*/
	//-----------------------------tdg
	//---------------------------luoqin
	//-------------------zhangying
